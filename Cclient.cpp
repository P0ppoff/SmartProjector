...
#include <gdk/gdkx.h>
 ...
 // COMPILATION
 // g++ Cclient.cpp -o Cclient `pkg-config --cflags --libs gtk+-3.0 gstreamer-1.0 gstreamer-video-1.0 gstreamer-base-1.0`
...
main (int argc, char *argv[])
{
 ...
 gchar str[1000];
#ifdef __APPLE__
	sprintf(str,"gst-launch-1.0 rtpbin name=rtpbin avfvideosrc capture-screen=true \
